...
//   const userId = localStorage.getItem("userId"); // save on login
...
//       const data = await res.json();
//       setAnswerBody("");
//       // The new answer will be added via socket 'newAnswer'
//     } catch (err) {
//       console.error(err);
//     }
//   }

//   // Vote function (upvote or downvote) with optimistic update
...
//       const data = await res.json(); // contains updated upvotes and downvotes arrays
...
//             <div
//               key={a._id}
//               style={{ border: "1px solid #ddd", padding: 5, marginBottom: 5 }}
//             >
//               <p>{a.body}</p>
//               <small>
//                 By: {a.author?.name} · Upvotes: {Array.isArray(a.upvotes) ? a.upvotes.length : 0} · Downvotes: {Array.isArray(a.downvotes) ? a.downvotes.length : 0}
//               </small>
//               <br />
//               <button
//                 disabled={hasUpvoted}
